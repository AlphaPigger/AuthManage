...
{
    [ViewComponent(Name= "ItemBaseOnHardwareDelete")]
    public class ItemBaseOnHardwareDeleteViewComponent:ViewComponent
    {
        //依赖注入
        private IMenuAppService _menuAppService;
        //构造函数
        public ItemBaseOnHardwareDeleteViewComponent(IMenuAppService menuAppService)
        {
            _menuAppService = menuAppService;
        }
        public IViewComponentResult Invoke(int ItemBaseOnHardwareID)
        {
            ViewBag.ItemBaseOnHardwareID = ItemBaseOnHardwareID;
