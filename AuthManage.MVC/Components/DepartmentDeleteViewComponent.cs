...
{
    [ViewComponent(Name ="DepartmentDelete")]
    public class DepartmentDeleteViewComponent:ViewComponent
    {
        //依赖注入
        private IMenuAppService _menuAppService;
        //构造函数
        public DepartmentDeleteViewComponent(IMenuAppService menuAppService)
        {
