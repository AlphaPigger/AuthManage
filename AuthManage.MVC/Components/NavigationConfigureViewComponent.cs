...
{
    [ViewComponent(Name ="NavigationConfigure")]
    public class NavigationConfigureViewComponent:ViewComponent
    {
        //依赖注入
        private IMenuAppService _menuAppService;
        //构造函数
        public NavigationConfigureViewComponent(IMenuAppService menuAppService)
        {
