...
{
    [ViewComponent(Name= "ItemBaseOnHardwareAdd")]
    public class ItemBaseOnHardwareAddViewComponent:ViewComponent
    {
        //依赖注入
        private IMenuAppService _menuAppService;
        //构造函数
        public ItemBaseOnHardwareAddViewComponent(IMenuAppService menuAppService)
        {
