...
{
    [ViewComponent(Name ="DepartmentEdit")]
    public class DepartmentEditViewComponent:ViewComponent
    {
        //依赖注入
        private IMenuAppService _menuAppService;
        //构造函数
        public DepartmentEditViewComponent(IMenuAppService menuAppService)
        {
