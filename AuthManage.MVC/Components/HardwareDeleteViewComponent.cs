...
{
    [ViewComponent(Name ="HardwareDelete")]
    public class HardwareDeleteViewComponent:ViewComponent
    {
        //依赖注入
        private IMenuAppService _menuAppService;
        //构造函数
        public HardwareDeleteViewComponent(IMenuAppService menuAppService)
        {
            _menuAppService = menuAppService;
        }
        public IViewComponentResult Invoke(int hardwareID)
        {
            ViewBag.hardwareID = hardwareID;
