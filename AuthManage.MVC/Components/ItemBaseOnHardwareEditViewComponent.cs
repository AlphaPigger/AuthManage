...
{
    [ViewComponent(Name = "ItemBaseOnHardwareEdit")]
    public class ItemBaseOnHardwareEditViewComponent:ViewComponent
    {
        //依赖注入
        private IMenuAppService _menuAppService;
        //构造函数
        public ItemBaseOnHardwareEditViewComponent(IMenuAppService menuAppService)
        {
