...
{
    [ViewComponent(Name= "NavigationTool")]
    public class NavigationToolViewComponent:ViewComponent
    {
        //依赖注入
        private IMenuAppService _menuAppService;
        //构造函数
        public NavigationToolViewComponent(IMenuAppService menuAppService)
        {
